...
urlpatterns = [
    ...
    path("cert_signature/apply/<slug:certificate_id>", ApplyView.as_view(), name="cert_apply"),
    path("cert_signature/deni/<slug:certificate_id>", DeniView.as_view(), name="cert_deni"),
]
